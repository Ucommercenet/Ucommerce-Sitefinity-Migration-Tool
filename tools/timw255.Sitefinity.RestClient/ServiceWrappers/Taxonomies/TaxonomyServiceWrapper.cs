...
namespace timw255.Sitefinity.RestClient.ServiceWrappers.Taxonomies
{
    public class TaxonomyServiceWrapper : ServiceWrapper
    {
        ...
        public CollectionContext<WcfTaxonomy> GetTaxonomies(string provider, string sortExpression, int skip, int take, string filter, string taxonomyType, string culture = null)
        {
